...
//             <img src={candidate.markSheet} loading="lazy" alt="Marksheet" style={{ maxWidth: "100%", height: "auto", borderRadius: 10 }} />
//           </Box>
//         ) : (
//           <Typography color="error">No marksheet available</Typography>
//         )}
//       </Paper>

//       {/* ID Card Section with Flexbox */}
//       <Paper sx={{ p: 3 }}>
//         <Typography variant="h5" color="primary" gutterBottom>
//           ID Card
//         </Typography>
...
//               <img src={candidate.idCardFront} loading="lazy" alt="ID Card Front" style={{ width: "100%", maxWidth: "250px", borderRadius: 10 }} />
//             ) : (
//               <Typography color="error">No ID Front Image</Typography>
//             )}
//           </Box>
//           <Box sx={{ flex: 1, textAlign: "center" }}>
//             <Typography variant="h6">Back</Typography>
//             {candidate.idCardBack ? (
//               <img src={candidate.idCardBack} loading="lazy"  alt="ID Card Back" style={{ width: "100%", maxWidth: "250px", borderRadius: 10 }} />
//             ) : (
//               <Typography color="error">No ID Back Image</Typography>
//             )}
//           </Box>
//         </Box>
//       </Paper>
